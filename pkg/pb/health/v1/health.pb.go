...
const file_health_v1_health_proto_rawDesc = "" +
	"\n" +
	"\x16health/v1/health.proto\x12\thealth.v1\"\x0f\n" +
	"\rHealthRequest\"@\n" +
	"\x0eHealthResponse\x12\x14\n" +
	"\x05alive\x18\x01 \x01(\bR\x05alive\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage2L\n" +
	"\rHealthService\x12;\n" +
	"\x04Ping\x12\x18.health.v1.HealthRequest\x1a\x19.health.v1.HealthResponseB\x1bZ\x19pkg/pb/health/v1;healthv1b\x06proto3"
...
var file_health_v1_health_proto_depIdxs = []int32{
	0, // 0: health.v1.HealthService.Ping:input_type -> health.v1.HealthRequest
	1, // 1: health.v1.HealthService.Ping:output_type -> health.v1.HealthResponse
